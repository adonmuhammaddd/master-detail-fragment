package crispyid.co.id.masterdetaildemo;
...
import crispyid.co.id.masterdetaildemo.ItemsListFragment.OnItemSelectedListener;
	...
	private void determinePaneLayout() {
		...
		if (fragmentItemDetail != null) {
			...
			ItemsListFragment fragmentItemsList = 
					(ItemsListFragment) getSupportFragmentManager().findFragmentById(R.id.fragment1);
